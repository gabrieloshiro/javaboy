...
//                    }
                ...
                case 0xD1:               // POP DE
                    pc.inc();
                    e = JavaBoy.unsign(addressRead(sp.intValue()));
                    d = JavaBoy.unsign(addressRead(sp.intValue() + 1));
                    sp.inc();
                    sp.inc();
                    break;
                ...
                case 0xD5:               // PUSH DE
                    ...
                    sp.dec();
                    //sp &= 0xFFFF;
                    addressWrite(sp.intValue(), e);
                    addressWrite(sp.intValue() + 1, d);
                    break;
                case 0xD6:               // SUB A, nn
                    pc.inc();
                    pc.inc();
